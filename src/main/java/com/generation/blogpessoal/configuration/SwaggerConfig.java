    ...
    OpenAPI springBlogPessoalOpenAPI() {
        return new OpenAPI()
            .info(new Info()
                ...
                .description("Projeto Blog Pessoal - Thais Santana")
                .version("v0.0.1")
                .license(new License()
                    .name("Thais Santana")
                    .url("https://github.com/ThaisSantanaa"))
                .contact(new Contact()
                    .name("Thais Santana")
                    .url("https://www.linkedin.com/in/thais-de-lima-santana/")
                    .email("thaislimasantana9@gmail.com")))
